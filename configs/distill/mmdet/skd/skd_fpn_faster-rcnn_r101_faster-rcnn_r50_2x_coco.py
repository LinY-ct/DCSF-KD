...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_skd_fpn0=dict(type='SKDLoss', loss_weight=6),
            loss_skd_fpn1=dict(type='SKDLoss', loss_weight=6),
            loss_skd_fpn2=dict(type='SKDLoss', loss_weight=6),
            loss_skd_fpn3=dict(type='SKDLoss', loss_weight=6)),
