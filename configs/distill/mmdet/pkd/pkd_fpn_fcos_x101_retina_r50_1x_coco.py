...
model = dict(
    ...
    distiller=dict(
            ...
            distill_losses=dict(
                loss_pkd_fpn0=dict(type='PKDLoss', loss_weight=1),
                loss_pkd_fpn1=dict(type='PKDLoss', loss_weight=1),
                loss_pkd_fpn2=dict(type='PKDLoss', loss_weight=1),
                loss_pkd_fpn3=dict(type='PKDLoss', loss_weight=1)),
