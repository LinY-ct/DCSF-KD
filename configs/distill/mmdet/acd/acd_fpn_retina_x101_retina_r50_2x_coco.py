_base_ = ['./acd_fpn_faster-rcnn_r101_faster-rcnn_r50_2x_coco.py']
...
model = dict(
    ...
    distiller=dict(
        distill_losses=dict(
            loss_pkd_fpn0=dict(type='ACDLoss', loss_weight=2),
            loss_pkd_fpn1=dict(type='ACDLoss', loss_weight=2),
            loss_pkd_fpn2=dict(type='ACDLoss', loss_weight=2),
            loss_pkd_fpn3=dict(type='ACDLoss', loss_weight=2))))
