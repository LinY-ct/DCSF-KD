_base_ = ['./acd_fpn_retina_x101_retina_r50_2x_coco.py']
...
model = dict(
    architecture=dict(
        cfg_path='mmdet::fcos/fcos_r50-caffe_fpn_gn-head_1x_coco.py'),
    teacher=dict(
        cfg_path=  # noqa: E251
    ...
    distiller=dict(
            ...
            distill_losses=dict(
                loss_acd_fpn0=dict(type='ACDLoss', loss_weight=2),
                loss_acd_fpn1=dict(type='ACDLoss', loss_weight=2),
                loss_acd_fpn2=dict(type='ACDLoss', loss_weight=2),
                loss_acd_fpn3=dict(type='ACDLoss', loss_weight=2)),
