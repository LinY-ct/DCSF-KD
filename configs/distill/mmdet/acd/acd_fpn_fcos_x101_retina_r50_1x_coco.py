...
model = dict(
    ...
    distiller=dict(
            ...
            distill_losses=dict(
                loss_acd_fpn0=dict(type='ACDLoss', loss_weight=1),
                loss_acd_fpn1=dict(type='ACDLoss', loss_weight=1),
                loss_acd_fpn2=dict(type='ACDLoss', loss_weight=1),
                loss_acd_fpn3=dict(type='ACDLoss', loss_weight=1)),
